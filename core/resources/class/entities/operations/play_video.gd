...
## An [Entity] that represents the start of the playback for a [VideoEntity],
## until a specific time in the video.

## The position in seconds at which the video will stop playing.
@export var until_position: float = 0.0

var video_id: String = ""

## The [VideoEntity] that will be played.
